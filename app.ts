...
const functionSelect = document.getElementById('function') as HTMLSelectElement;
...
edgarImage.onload = () => {
    ...
    function drawTrigFunction(
        ...
        for (let x = 0; x < width; x++) {
            ...
            if (func === 'sin') {
                ...
                if (Math.abs(y) > 10) continue; // Tangens begrenzen
            }
    ...
    function updateGraph() {
        ...
        const func = functionSelect.value as 'sin' | 'cos' | 'tan';
